...
def header():
    ...
    response.write("<a href='/test/blurExpect'>blurExpect</a></div><br>")

    response.write("<div><a href='/test/responsiveCard'>responsiveCard</a>")
    response.write("<a href='/test/loadingEffects'>loadingEffects</a></div><br><br>")
